...
<ArcPad>
	<LAYER name="SKETCHES_LINE" maxscale="1:10000.000000" readonly="true">
		<SYMBOLOGY>
			...
			<SIMPLERENDERER>
				<COMPLEXLINESYMBOL color="Red" width="1" pattern="MMMMMG"/>
			</SIMPLERENDERER>
		</SYMBOLOGY>
		<FORMS>
			<EDITFORM name="SKETCHES_LINE" caption="SKETCHES_LINE" width="130" height="130" attributespagevisible="false">
			...
			<QUERYFORM name="QUERYFORM" caption="Query Form" width="130" height="130">
				<PAGE name="page1" caption="SKETCHES_LINE Query (Page 1)">
					<LABEL name="lblID" x="2" y="3" width="60" height="12" tabstop="false" caption="ID">
					</LABEL>
				...
				<PAGE name="page2" caption="SKETCHES_LINE Query (Page 2)">
					<LABEL name="lblWIDTH" x="2" y="3" width="60" height="12" tabstop="false" caption="WIDTH">
					</LABEL>
